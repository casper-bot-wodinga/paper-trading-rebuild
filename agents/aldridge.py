#!/usr/bin/env python3
"""
Aldridge (Value) Trader Agent — structured logging agent entry point.

Usage:
    python3 agents/aldridge.py                   # run continuously
    python3 agents/aldridge.py --once            # one tick and exit
    python3 agents/aldridge.py --mock            # skip network calls

Logs:
    - logs/agents/aldridge.jsonl     — structured JSON-lines log
    - logs/agents/aldridge.log       — human-readable log
"""
